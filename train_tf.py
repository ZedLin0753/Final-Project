...
number = ['11','12','13','14','15','16','17','18','19','21','22','23','24','25','26','27','28','29','31','32','33','34','35','36','37','38','39','41','42','43','44','45','46','47']

all_train_files = split_data.get_all_files('./train_cnn')
all_test_files = split_data.get_all_files('./test_cnn')
...
def get_next_batch(batch_size = 32, files = all_train_files):
...
if __name__ == '__main__':
    ...
    train_cnn()
    print('訓練耗時 (s) : ', time.time() - global_start_time)
